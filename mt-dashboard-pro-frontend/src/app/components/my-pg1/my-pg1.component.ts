...
@Component({
    templateUrl: './my-pg1.component.html',
    styleUrls: ['./my-pg1.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: false
})

export class MyPg1Component implements OnChanges, ProgramPresenter {
    ...
    @Input() contributedNode: MyPg1Node;
